...
public class PostFollow extends android.support.v4.app.Fragment {
    private View view;
    private Context c;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFirebaseRef = FirebaseDatabase.getInstance().getReference().child("FollowPost").child(globalVariable.cur_user);
