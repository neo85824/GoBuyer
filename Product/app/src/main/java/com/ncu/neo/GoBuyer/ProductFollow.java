...
public class ProductFollow extends android.support.v4.app.Fragment {
    private View view;
    private Context c;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFirebaseRef = FirebaseDatabase.getInstance().getReference().child("FollowProduct").child(globalVariable.cur_user);
        followFirebaseRef = FirebaseDatabase.getInstance().getReference().child("FollowProduct");
        c = getContext();
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Post, PostViewHolder>(
            ...
            protected void populateViewHolder(final PostViewHolder postViewHolder, final Post post, int i) {
                ...
                postViewHolder.setProductFollowBtn(post_key, globalVariable.cur_user);
                ...
                postViewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setClass(c , BuyerProductActivity.class);
                                ...
                                if(mProcessFollow) {
                                    if (dataSnapshot.child(globalVariable.cur_user).hasChild(post_key)) {
                                        ...
                                        new AlertDialog.Builder(getContext())
                                                ...
                                                .show();
                                        postViewHolder.textView_follow.setText("我要追蹤");
                                        ...
                                        new AlertDialog.Builder(getContext())
                                                ...
                                                .show();
                                        postViewHolder.textView_follow.setText("取消追蹤");
                                        mProcessFollow = false;
                                    }
                                }
                            }
