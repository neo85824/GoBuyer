...
public class BuyerPostHasValueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_post_has_value);


        setSpinner();

        post = (Post) getIntent().getSerializableExtra("Post");  //接資料
        ...
        if(post != null)
        {
            ...
            editText_name.setText(post.getName());

            mSelectImage = (ImageView) findViewById(R.id.imageView_upload);
            Glide.with(BuyerPostHasValueActivity.this)
                    .load(post.getImageURL())
                    .into(mSelectImage);


            spinner_country = (Spinner)findViewById(R.id.spinner_country);
            ArrayAdapter<String> array_spinner=(ArrayAdapter<String>)spinner_country.getAdapter();
            spinner_country.setSelection(array_spinner.getPosition(post.getCountry()));
        ...
        imageView_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BuyerPostHasValueActivity.this.finish();
            }
        });
        ...
        imageView_getRequest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent().setClass(BuyerPostHasValueActivity.this, GoerViewActivity.class));
            }
        });
        ...
        imageView_following.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent().setClass(BuyerPostHasValueActivity.this, FollowingActivity.class));
            }
        });
        ...
        button_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(editText_name.getText()) && !TextUtils.isEmpty(editText_price.getText()) && mSelectImage != null) {
                    ...
                    intent.setClass(BuyerPostHasValueActivity.this, BuyerPost2Activity.class);
                ...
                {
                    new AlertDialog.Builder(BuyerPostHasValueActivity.this)
                            .setTitle("送出錯誤")
    ...
    void setSpinner()
    {
        ...
        ArrayAdapter<CharSequence> numberList = ArrayAdapter.createFromResource(BuyerPostHasValueActivity.this,
                R.array.number,
                android.R.layout.simple_spinner_dropdown_item);
        spinner_number.setAdapter(numberList);

        ArrayAdapter<CharSequence> countryList = ArrayAdapter.createFromResource(BuyerPostHasValueActivity.this,
                R.array.country,
                android.R.layout.simple_spinner_dropdown_item);
        spinner_country.setAdapter(countryList);

        ArrayAdapter<CharSequence> catalog1List = ArrayAdapter.createFromResource(BuyerPostHasValueActivity.this,
                R.array.catalog,
                android.R.layout.simple_spinner_dropdown_item);
        spinner_catalog.setAdapter(catalog1List);


        ArrayAdapter<CharSequence> weightList = ArrayAdapter.createFromResource(BuyerPostHasValueActivity.this,
                R.array.weight,
                android.R.layout.simple_spinner_dropdown_item);
        spinner_weight.setAdapter(weightList);


        ArrayAdapter<CharSequence> timelist = ArrayAdapter.createFromResource(BuyerPostHasValueActivity.this,
                R.array.time,
                android.R.layout.simple_spinner_dropdown_item);
