...
public class Product implements Serializable
{
    ...
    public Product(String name, String price, String number, String country, String catalog, String weight, String time, String imageURL, String user) {
        this.name = name;
        this.price = price;
        this.number = number;
